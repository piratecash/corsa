...
| [Network](network.md) | `getPeers`, `fetchPeerHealth`, `fetchNetworkStats`, `addPeer`, `connectOnly`, `fetchReachableIds`, `getActiveConnections` | [network.md](network.md) |
...
| [File Transfer](file.md) | `sendFileAnnounce`, `fetchFileTransfers`, `fetchAllFileTransfers`, `fetchFileMapping`, `retryFileChunk`, `startFileDownload`, `cancelFileDownload`, `explainFileRoute` | [file.md](file.md) |
...
| [Сеть](network.md) | `getPeers`, `fetchPeerHealth`, `fetchNetworkStats`, `addPeer`, `connectOnly`, `fetchReachableIds`, `getActiveConnections` | [network.md](network.md) |
...
| [Файловый трансфер](file.md) | `sendFileAnnounce`, `fetchFileTransfers`, `fetchAllFileTransfers`, `fetchFileMapping`, `retryFileChunk`, `startFileDownload`, `cancelFileDownload`, `explainFileRoute` | [file.md](file.md) |
