...
var messages = map[string]map[string]string{
	"en": {
		...
		"console.suggestions_hint":     "Suggestions: click a command template to insert it.",
		"node.title":                   "Node",
	...
	"ru": {
		...
		"console.suggestions_hint":     "Подсказки: нажмите на шаблон команды, чтобы подставить его.",
		"node.title":                   "Узел",
