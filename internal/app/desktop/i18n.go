...
var messages = map[string]map[string]string{
	"en": {
		...
		"status.trust_rebuilding":  "Rebuilding contacts from peers...",
		"status.trust_rebuilt":     "Trust rebuild complete. Contacts: %d",
		"status.trust_failed":      "Trust rebuild failed: %s",
		...
		"node.trust_rebuild":       "Trust Rebuild",
		"chat.title":               "Chat",
	...
	"ru": {
		...
		"status.trust_rebuilding":  "Пересборка contacts у пиров...",
		"status.trust_rebuilt":     "Пересборка trust завершена. Contacts: %d",
		"status.trust_failed":      "Ошибка пересборки trust: %s",
		...
		"node.error.none":          "нет",
		"node.trust_rebuild":       "Пересобрать trust",
		"chat.title":               "Чат",
		"chat.with":                "Чат с %s",
	...
	"es": {
		...
		"status.trust_rebuilding":  "Reconstruyendo contactos desde peers...",
		"status.trust_rebuilt":     "Reconstrucción completada. Contactos: %d",
		"status.trust_failed":      "Error al reconstruir confianza: %s",
		...
		"node.trust_rebuild":       "Reconstruir confianza",
		"chat.title":               "Chat",
	...
	"fr": {
		...
		"status.trust_rebuilding":  "Reconstruction des contacts depuis les pairs...",
		"status.trust_rebuilt":     "Reconstruction terminée. Contacts : %d",
		"status.trust_failed":      "Échec de la reconstruction : %s",
		...
		"node.trust_rebuild":       "Reconstruire la confiance",
		"chat.title":               "Chat",
	...
	"ar": {
		...
		"status.trust_rebuilding":  "جارٍ إعادة بناء جهات الاتصال من الأقران...",
		"status.trust_rebuilt":     "اكتملت إعادة البناء. جهات الاتصال: %d",
		"status.trust_failed":      "فشلت إعادة بناء الثقة: %s",
		...
		"node.trust_rebuild":       "إعادة بناء الثقة",
		"chat.title":               "الدردشة",
	...
	"zh": {
		...
		"status.trust_rebuilding":  "正在从 peers 重建联系人...",
		"status.trust_rebuilt":     "重建完成。联系人：%d",
		"status.trust_failed":      "重建信任失败：%s",
