...
// snapshots: the Routes map and the Total/Active counters. FlapState / Health /
// CapStats are produced identically by both paths (incremental
...
// so the projection contract is fully captured by these values.
